...
public class Commands {
    ...
    public static String differentiate(String expression, String variable) {
        Expression exprToDiff = Expression.parse(expression);
        return exprToDiff.differentiate(variable).toString();
    }
    ...
    public static String simplify(String expression, Map<String,Double> environment) {
        Expression exprToSimplify = Expression.parse(expression);
        return exprToSimplify.simplify(environment).toString();
    }
